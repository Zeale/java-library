 ...
 * any object in the Garthchat system. GIDs are currently split into a total of
 * 20 bytes.
 * </p>
 * <p>
 * <ol>
 ...
 * in respect to all other Garthchat objects created on the same
 * millisecond.</li>
...
public class GID implements Comparable<GID> {
	 ...
	 *         {@link GID}'s bytes. The {@link String} will always be twice the size
	 *         of the length of this {@link GID}'s bytes. The bytes can be retrieved
	 *         with {@link #getBytes()}.
	 * @author Gartham
	 */
